Tt's an app to manage the tasks.Task manager gives opportinuties to create, get, change and delete tasks. Each of the tasks includes: id, task title, description, deadline and assignee. 
